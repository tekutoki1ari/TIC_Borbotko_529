...
def encode():
    ...
    with open("results_jpeg.txt", "a") as file:
        print('Дані для сильнотекстурованого зображення RGB (таблиця 2)', file=file)
...
def decoder():
    dc, ac, tables, blocks_count = read_image_file("3_3_table2.asf")
    ...
    filename = f"JPEG_{'3_3_result_img_2'}.jpg"
    image.save(filename)
